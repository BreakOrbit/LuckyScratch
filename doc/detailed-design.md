...
| 4. 奖项加密 | 系统使用 Zama FHE 加密奖项分布，完成池初始化 |
| 5. 池上线 | 池子出现在「用户池」Tab 下，对所有用户可见 |
...
| 状态显示 | 卡片内显示：`Reward added to your private balance` |
...
| 隐私强调 | `Only visible to you` / `Reward added to your private balance` |
