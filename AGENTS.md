...
- `packages/nextjs/app/my-tickets/page.tsx` now renders a dedicated wallet-driven ticket vault through `packages/nextjs/components/my-tickets/MyTicketsVault.tsx`; the old `packages/nextjs/app/tickets/` reveal workspace and scaffold `packages/nextjs/app/debug/` page have been removed
