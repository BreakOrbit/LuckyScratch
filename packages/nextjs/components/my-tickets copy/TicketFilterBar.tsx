    ...
    <section className="mb-10 space-y-4">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <button className="flex-1 md:flex-none px-6 py-2.5 bg-[#232a3b] border border-[#4d4732]/50 text-[#dce2f9] rounded-lg font-bold text-sm hover:bg-[#32394a] transition-all flex items-center justify-center gap-2">
          ...
          <button className="flex-1 md:flex-none px-6 py-2.5 bg-[#ffd700] text-[#705e00] rounded-lg font-bold text-sm shadow-[0_0_15px_rgba(255,215,0,0.2)] hover:scale-105 transition-all flex items-center justify-center gap-2">
