...
import (
	...
	contractabi "lucky-scratch/contracts/abi"
...
func ImportArtifacts(ctx context.Context, queries db.Querier, cfg config.Config) error {
...
func LoadRegistry(ctx context.Context, queries db.Querier, cfg config.Config) (Registry, error) {
